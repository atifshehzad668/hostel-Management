...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('admin-assets/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback') }}">
    <!-- Font Awesome -->
    ...
    <link rel="stylesheet" href="{{ asset('admin-assets/libs/datatables.bootstrap5.css') }}">
