...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form id="roomForm" name="roomForm" enctype="multipart/form-data" method="POST">
                @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="room_name" id="room_name" class="form-control"
                                        value="{{ $room->room_name }}" placeholder="Room name">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="room_type" id="room_type" class="form-control">
                                        ...
                                        <option value="Single" {{ $room->room_type == 'Single' ? 'selected' : '' }}>Single
                                        </option>
                                        <option value="Multiple" {{ $room->room_type == 'Multiple' ? 'selected' : '' }}>
                                            Multiple</option>
                                    </select>
                                    <p class="text-danger"></p>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_of_seats" id="no_of_seats" class="form-control"
                                        value="{{ $room->no_of_seats }}" placeholder="NO OF SEATS">
                                    <p class="text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('rooms.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
