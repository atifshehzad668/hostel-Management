        ...
        <div class="container-fluid">
            <form id="FloorForm" enctype="multipart/form-data" name="FloorForm">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="floor_name" value="{{ $floor->floor_name }}" id="floor_name"
                                        class="form-control" placeholder="Floor Nmae">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" cols="30" rows="10">{{ $floor->description }}</textarea>
                                    <p class="text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $floor->total_rooms }}" name="total_rooms"
                                        id="total_rooms" class="form-control" placeholder="Total Rooms">
                                    <p class="text-danger"></p>
                                </div>
                            </div>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('floor.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
...
@section('customjs')
    <script>
        $("#FloorForm").submit(function(event) {
            ...
            $.ajax({
                url: '{{ route('floor.update', $floor->id) }}',
                type: 'Post',
