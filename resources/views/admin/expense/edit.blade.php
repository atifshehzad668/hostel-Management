                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="expense_head_id" id="expense_head_id" class="form-control">
                                        ...
                                        @foreach ($expenseHeads as $expenseHead)
                                            <option {{ $expense->expense_head_id == $expenseHead->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date" id="date" class="form-control"
                                        placeholder="Date" value="{{ $expense->paying_date }}">
                                    <p class="text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" placeholder="bill,other staff" class="form-control" cols="30"
                                        rows="10">{{ $expense->description }}</textarea>
                                    <p class="text-danger"></p>
                                </div>
                            </div>
...
@section('customjs')
    <script>
        $("#expenseForm").submit(function(event) {
            ...
            $.ajax({
                url: '{{ route('expense.update', $expense->id) }}',
                type: 'Post',
